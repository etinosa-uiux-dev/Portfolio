...
function About () {
    ...
    return (
        <section id="about" data-title="About" className="p-5 pb-10">
            <div>
                <h1 className="text-3xl font-bold mb-20">About Me</h1>
                <div className="flex justify-center items-center">
                    <div className="mb-10 tab:w-200">
                        <div className="bg-zinc-400 w-20 h-20 rounded-full overflow-hidden float-left mr-5 mb-1">
                            <img className="w-full h-full object-cover" src={abtImg} alt="" />
                        </div>
                        
                        <p className="leading-7.5 lmobile:leading-8 tab:text-lg tab:leading-10">
                            ...
                            To see my work, you can scroll or navigate to the <a className="inline-block text-purple-500" href="#projects">Projects</a> section. 
                        </p>
                    </div>
                </div>
            </div>
